 ...
 * slightly more expressive. For example: assertThat(cheese, equalTo(smelly))
...
public class Is<T> extends BaseMatcher<T> {
     ...
     * be slightly more expressive. For example: assertThat(cheese,
     * equalTo(smelly)) vs. assertThat(cheese, is(equalTo(smelly)))
     */
    @Factory
    ...
    /**
     * This is a shortcut to the frequently used is(equalTo(x)). For example:
     * assertThat(cheese, is(equalTo(smelly))) vs. assertThat(cheese,
     * is(smelly))
     */
    @Factory
