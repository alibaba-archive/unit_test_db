...
class Entities {
    ...
    static class ArrayEntityMap implements EntityMap {
         ...
         * 
         * @param growBy array will be initialized to and will grow by this
         *            amount
         */
     ...
     * </p>
     * 
     * @param writer The <code>Writer</code> to write the results of the
     *            escaping to. Assumed to be a non-null value.
     * @param str The <code>String</code> to escape. Assumed to be a non-null
     *            value.
     ...
     * </p>
     * 
     * @param writer The <code>Writer</code> to write the results to; assumed to
     *            be non-null.
     * @param str The source <code>String</code> to unescape; assumed to be
     *            non-null.
     * @throws IOException when <code>Writer</code> passed throws the exception
     *             from calls to the {@link Writer#write(int)} methods.
     * @see #escape(String)
     ...
     * @param str The source <code>String</code> to unescape; assumed to be
     *            non-null.
     * @param firstAmp The <code>int</code> index of the first ampersand in the
     *            source String.
     * @throws IOException when <code>Writer</code> passed throws the exception
     *             from calls to the {@link Writer#write(int)} methods.
     */
