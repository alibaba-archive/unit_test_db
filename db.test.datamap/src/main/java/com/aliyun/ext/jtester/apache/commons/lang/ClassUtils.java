 ...
 */
package com.aliyun.ext.jtester.apache.commons.lang;
...
public class ClassUtils {
     ...
     * @throws ClassCastException if <code>classes</code> contains a non-
     ...
     * Method is invokable and doesn't fall foul of Java bug
     * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4071957" >
     * 4071957</a>). <pre>Set set = Collections.unmodifiableSet(...);
     *  Method method = ClassUtils.getPublicMethod(set.getClass(), "isEmpty",  new Class[0]);
     *  Object result = method.invoke(set, new Object[]);</pre>
     * <p>
     * 
     ...
     *             class or if the metothod doen't conform with the requirements
     */
    public static Method getPublicMethod(Class cls, String methodName, Class parameterTypes[])
        ...
        throw new NoSuchMethodException(
                "Can't find a public method for " + methodName + " " + ArrayHelper.toString(parameterTypes));
    }
     ...
     * </p>
     * 
     * @param canonicalName the canonical name to get the package name for, may
     *            be <code>null</code>
     * @return the package name or an empty string
     * @since 2.4
     */
