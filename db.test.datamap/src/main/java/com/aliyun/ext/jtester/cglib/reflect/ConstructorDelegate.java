...
abstract public class ConstructorDelegate {
    private static final ConstructorKey KEY_FACTORY = (ConstructorKey) KeyFactory.create(ConstructorKey.class,
    ...
    public static class Generator extends AbstractClassGenerator {
        ...
        private static final Type   CONSTRUCTOR_DELEGATE = TypeUtils.parseType("ConstructorDelegate");
        ...
        public void generateClass(ClassVisitor v) {
            ...
            ce.begin_class(Constants.V1_2, Constants.ACC_PUBLIC, getClassName(), CONSTRUCTOR_DELEGATE,
                    new Type[] { Type.getType(iface) }, Constants.SOURCE_FILE);
            Type declaring = Type.getType(constructor.getDeclaringClass());
            EmitUtils.null_constructor(ce);
            CodeEmitter e = ce.begin_method(Constants.ACC_PUBLIC, ReflectUtils.getSignature(newInstance),
