...
import com.aliyun.ext.jtester.cglib.core.ClassInfo;
...
class MethodInterceptorGenerator implements CallbackGenerator {
    ...
    private static final Type                      REFLECT_UTILS         = TypeUtils.parseType("ReflectUtils");
    private static final Type                      METHOD_PROXY          = TypeUtils.parseType("MethodProxy");
    private static final Type                      METHOD_INTERCEPTOR    = TypeUtils.parseType("MethodInterceptor");
    private static final Signature                 GET_DECLARED_METHODS  = TypeUtils
            .parseSignature("java.lang.reflect.Method[] getDeclaredMethods()");
    @SuppressWarnings("unused")
    private static final Signature                 GET_DECLARING_CLASS   = TypeUtils
            .parseSignature("Class getDeclaringClass()");
    private static final Signature                 FIND_METHODS          = TypeUtils
    ...
    private static final Signature                 MAKE_PROXY            = new Signature("create", METHOD_PROXY,
            new Type[] { Constants.TYPE_CLASS, Constants.TYPE_CLASS, Constants.TYPE_STRING, Constants.TYPE_STRING,
                    Constants.TYPE_STRING });
    private static final Signature                 INTERCEPT             = new Signature("intercept",
            Constants.TYPE_OBJECT,
            new Type[] { Constants.TYPE_OBJECT, METHOD, Constants.TYPE_OBJECT_ARRAY, METHOD_PROXY });
    private static final Signature                 FIND_PROXY            = new Signature(FIND_PROXY_NAME, METHOD_PROXY,
    ...
    public void generateStatic(CodeEmitter e, Context context, List methods) throws Exception {
        /*
         * generates: static { Class thisClass =
         * Class.forName("NameOfThisClass"); Class cls =
         * Class.forName("java.lang.Object"); String[] sigs = new String[]{
         * "toString", "()Ljava/lang/String;", ... }; Method[] methods =
         * cls.getDeclaredMethods(); methods = ReflectUtils.findMethods(sigs,
         * methods); METHOD_0 = methods[0]; CGLIB$ACCESS_0 =
         * MethodProxy.create(cls, thisClass, "()Ljava/lang/String;",
         * "toString", "CGLIB$ACCESS_0"); ... }
         */
    ...
    public void generateFindProxy(ClassEmitter ce, final Map sigMap) {
        ...
        EmitUtils.string_switch(e, (String[]) sigMap.keySet().toArray(new String[0]), Constants.SWITCH_STYLE_HASH,
                callback);
        e.end_method();
    }
}
