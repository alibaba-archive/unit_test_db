...
class DispatcherGenerator implements CallbackGenerator {
    ...
    private static final Type               DISPATCHER            = TypeUtils.parseType("Dispatcher");
    private static final Type               PROXY_REF_DISPATCHER  = TypeUtils.parseType("ProxyRefDispatcher");
