...
/**
 * Matcher for array whose elements satisfy a sequence of matchers. The array
 * size must equal the number of element matchers.
 */
public class IsArray<T> extends TypeSafeMatcher<T[]> {
    ...
    /**
     * Returns the string that starts the description. Can be overridden in
     * subclasses to customise how the matcher is described.
     */
    ...
    /**
     * Returns the string that separates the elements in the description. Can be
     * overridden in subclasses to customise how the matcher is described.
     */
    ...
    /**
     * Returns the string that ends the description. Can be overridden in
     * subclasses to customise how the matcher is described.
     */
