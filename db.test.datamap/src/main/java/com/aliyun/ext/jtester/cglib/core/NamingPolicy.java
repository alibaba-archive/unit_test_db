...
public interface NamingPolicy {
     ...
     * 
     * @param prefix a dotted-name chosen by the generating class (possibly to
     *            put the generated class in a particular package)
     * @param source the fully-qualified class name of the generating class (for
     *            example "ext.jtester.cglib.Enhancer")
     * @param key A key object representing the state of the parameters; for
     ...
     * @param names a predicate that returns true if the given classname has
     *            already been used in the same ClassLoader.
