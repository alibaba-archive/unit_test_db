 ...
 */
package com.aliyun.ext.jtester.apache.commons.io;
 ...
 * large numbers of bytes - significantly speeding up test execution times.
 * <p>
 * This implementation returns zero from the method that reads a byte and leaves
 * the array unchanged in the read methods that are passed a byte array. If
 * alternative data is required the <code>processByte()</code> and
 * <code>processBytes()</code> methods can be implemented to generate data
 *
...
public class NullInputStream extends InputStream {
    ...
    /**
     * Create an {@link InputStream} that emulates a specified size which
    ...
    /**
     * Create an {@link InputStream} that emulates a specified size with option
     * settings.
     *
     * @param size The size of the input stream to emulate.
     ...
     *            {@link EOFException} or return -1 when the end of file is
     *            reached.
     */
    ...
    /**
     * Close this input stream - resets the internal state to the initial
     * values.
     *
     ...
     * Read a byte.
     *
     * @return Either The byte value returned by <code>processByte()</code> or
     *         <code>-1</code> if the end of file has been reached and
     ...
     * @return The number of bytes read or <code>-1</code> if the end of file
     *         has been reached and <code>throwEofException</code> is set to
     *         <code>false</code>.
     * @throws EOFException if the end of file is reached and
     *             <code>throwEofException</code> is set to <code>true</code>.
     * @throws IOException if trying to read past the end of file.
     ...
     *
     * @throws UnsupportedOperationException if mark is not supported.
     * @throws IOException If no position has been marked or the read limit has
     *             been exceed since the last position was marked.
     */
    public synchronized void reset() throws IOException {
        ...
        if (position > (mark + readlimit)) {
            throw new IOException(
                    "Marked position [" + mark + "] is no longer valid - passed the read limit [" + readlimit + "]");
        }
        position = mark;
        eof = false;
    }
     ...
     * @return The number of bytes skipped or <code>-1</code> if the end of file
     *         has been reached and <code>throwEofException</code> is set to
     *         <code>false</code>.
     * @throws EOFException if the end of file is reached and
     *             <code>throwEofException</code> is set to <code>true</code>.
     ...
     * Handle End of File.
     *
     * @return <code>-1</code> if <code>throwEofException</code> is set to
     *         <code>false</code>
     * @throws EOFException if <code>throwEofException</code> is set to
     *             <code>true</code>.
     */
