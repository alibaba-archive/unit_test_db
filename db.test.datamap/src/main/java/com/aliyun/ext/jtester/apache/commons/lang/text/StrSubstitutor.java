...
public class StrSubstitutor {
     ...
     * the resolver using the given source string as a template.
     * <p>
     * Only the specified portion of the string will be processed. The rest of
     * the string is not processed, and is not returned.
     * 
     * @param source the string to replace in, null returns null
    ...
    /**
     * Replaces all the occurrences of variables with their matching values from
     * the resolver using the given source array as a template. The array is not
     ...
     * altered by this method.
     * <p>
     * Only the specified portion of the array will be processed. The rest of
     * the array is not processed, and is not returned.
     * 
     * @param source the character array to replace in, not altered, null
     *            returns null
     * @param offset the start offset within the array, must be valid
    ...
    /**
     * Replaces all the occurrences of variables with their matching values from
     * the resolver using the given source buffer as a template. The buffer is
     * not altered by this method.
     * 
     * @param source the buffer to use as a template, not changed, null returns
     *            null
     * @return the result of the replace operation
     */
     ...
     * not altered by this method.
     * <p>
     * Only the specified portion of the buffer will be processed. The rest of
     * the buffer is not processed, and is not returned.
     * 
     * @param source the buffer to use as a template, not changed, null returns
     *            null
     * @param offset the start offset within the array, must be valid
    ...
    /**
     * Replaces all the occurrences of variables with their matching values from
     * the resolver using the given source builder as a template. The builder is
     * not altered by this method.
     * 
     * @param source the builder to use as a template, not changed, null returns
     *            null
     * @return the result of the replace operation
     */
     ...
     * not altered by this method.
     * <p>
     * Only the specified portion of the builder will be processed. The rest of
     * the builder is not processed, and is not returned.
     * 
     * @param source the builder to use as a template, not changed, null returns
     *            null
     * @param offset the start offset within the array, must be valid
     ...
     * with their matching values from the resolver. The buffer is updated with
     * the result.
     * 
     ...
     * <p>
     * Only the specified portion of the buffer will be processed. The rest of
     * the buffer is not processed, but it is not deleted.
     * 
     * @param source the buffer to replace in, updated, null returns zero
     * @param offset the start offset within the array, must be valid
     ...
     * <p>
     * Only the specified portion of the builder will be processed. The rest of
     * the builder is not processed, but it is not deleted.
     * 
     ...
     * @param length the length within the builder to be processed, must be
     *            valid
     * @param priorVariables the stack keeping track of the replaced variables,
     *            may be null
     ...
     * @param startPos the start position of the variable including the prefix,
     *            valid
     ...
     * <p>
     * The variable prefix is the characer or characters that identify the start
     * of a variable. This method allows a single character prefix to be easily
     * set.
     * 
     ...
     * <p>
     * The variable prefix is the characer or characters that identify the start
     * of a variable. This method allows a string prefix to be easily set.
     * 
     * @param prefix the prefix for variables, not null
     * @return this, to enable chaining
     ...
     * <p>
     * The variable suffix is the characer or characters that identify the end
     * of a variable. This method allows a single character suffix to be easily
     * set.
     * 
     ...
     * <p>
     * The variable suffix is the characer or characters that identify the end
     * of a variable. This method allows a string suffix to be easily set.
     * 
     * @param suffix the suffix for variables, not null
     * @return this, to enable chaining
