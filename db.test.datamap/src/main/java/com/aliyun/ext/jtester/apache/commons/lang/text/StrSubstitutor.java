...
public class StrSubstitutor {
	 ...
	 * 
	 * @param source
	 *            the source text containing the variables to substitute, null
	 *            returns null
	 * @param valueMap
	 ...
	 * 
	 * @param source
	 *            the character array to replace in, not altered, null returns
	 *            null
	 * @return the result of the replace operation
	 */
	 ...
	 * 
	 * @param source
	 *            the buffer to use as a template, not changed, null returns
	 *            null
	 * @return the result of the replace operation
	 */
	 ...
	 * 
	 * @param source
	 *            the builder to use as a template, not changed, null returns
	 *            null
	 * @return the result of the replace operation
	 */
