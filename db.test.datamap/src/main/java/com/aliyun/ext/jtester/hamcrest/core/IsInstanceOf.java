...
import com.aliyun.ext.jtester.hamcrest.DiagnosingMatcher;
import com.aliyun.ext.jtester.hamcrest.Factory;
import com.aliyun.ext.jtester.hamcrest.Matcher;

/**
 * Tests whether the value is an instance of a class. Classes of basic types
 * will be converted to the relevant "Object" classes
 */
public class IsInstanceOf extends DiagnosingMatcher<Object> {
     ...
     *
     * @param expectedClass The predicate evaluates to true for instances of
    ...
    /**
     * Is the value an instance of a particular type? This version assumes no
     * relationship between the required type and the signature of the method
     * that sets it up, for example in
    ...
    /**
     * Is the value an instance of a particular type? Use this version to make
     * generics conform, for example in the JMock clause
