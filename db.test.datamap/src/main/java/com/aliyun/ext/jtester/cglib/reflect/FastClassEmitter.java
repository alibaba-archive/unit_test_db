 ...
 */
package com.aliyun.ext.jtester.cglib.reflect;

import java.lang.reflect.*;
import java.util.*;

import com.aliyun.ext.jtester.cglib.core.Block;
...
class FastClassEmitter extends ClassEmitter {
	...
	private static final Signature SIGNATURE_GET_INDEX = new Signature("getIndex", com.aliyun.ext.jtester.asm.Type.INT_TYPE,
			new com.aliyun.ext.jtester.asm.Type[] { Constants.TYPE_SIGNATURE });
	...
	private static final com.aliyun.ext.jtester.asm.Type FAST_CLASS = TypeUtils.parseType("FastClass");
	private static final com.aliyun.ext.jtester.asm.Type ILLEGAL_ARGUMENT_EXCEPTION = TypeUtils.parseType("IllegalArgumentException");
	private static final com.aliyun.ext.jtester.asm.Type INVOCATION_TARGET_EXCEPTION = TypeUtils
			.parseType("java.lang.reflect.InvocationTargetException");
	private static final com.aliyun.ext.jtester.asm.Type[] INVOCATION_TARGET_EXCEPTION_ARRAY = { INVOCATION_TARGET_EXCEPTION };

	public FastClassEmitter(ClassVisitor v, String className, Class type) {
		super(v);

		com.aliyun.ext.jtester.asm.Type base = com.aliyun.ext.jtester.asm.Type.getType(type);
	...
	private static void invokeSwitchHelper(final CodeEmitter e, List members, final int arg, final com.aliyun.ext.jtester.asm.Type base) {
		...
		e.process_switch(getIntRange(info.size()), new ProcessSwitchCallback() {
			public void processCase(int key, Label end) {
				...
				com.aliyun.ext.jtester.asm.Type[] types = method.getSignature().getArgumentTypes();
