...
class FastClassEmitter extends ClassEmitter {
    private static final Signature                         CSTRUCT_CLASS                     = TypeUtils
            .parseConstructor("Class");
    private static final Signature                         METHOD_GET_INDEX                  = TypeUtils
            .parseSignature("int getIndex(String, Class[])");
    private static final Signature                         SIGNATURE_GET_INDEX               = new Signature("getIndex",
            com.aliyun.ext.jtester.asm.Type.INT_TYPE,
            new com.aliyun.ext.jtester.asm.Type[] { Constants.TYPE_SIGNATURE });
    private static final Signature                         TO_STRING                         = TypeUtils
    ...
    private static final Signature                         GET_MAX_INDEX                     = TypeUtils
    ...
    private static final com.aliyun.ext.jtester.asm.Type   FAST_CLASS                        = TypeUtils
            .parseType("FastClass");
    private static final com.aliyun.ext.jtester.asm.Type   ILLEGAL_ARGUMENT_EXCEPTION        = TypeUtils
    ...
    private static final com.aliyun.ext.jtester.asm.Type[] INVOCATION_TARGET_EXCEPTION_ARRAY = {
    ...
    private static void invokeSwitchHelper(final CodeEmitter e, List members, final int arg,
                                           final com.aliyun.ext.jtester.asm.Type base) {
