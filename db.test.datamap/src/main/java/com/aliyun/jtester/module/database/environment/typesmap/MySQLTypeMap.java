package com.aliyun.jtester.module.database.environment.typesmap;
...
import com.aliyun.jtester.module.database.environment.typesmap.TypeMap.JavaSQLType;
...
public class MySQLTypeMap extends AbstractTypeMap {
	...
	public static Class getJavaType(String type) {
		TypeMap.JavaSQLType map = maps.get(type);
