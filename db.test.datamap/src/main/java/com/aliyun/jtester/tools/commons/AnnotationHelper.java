...
public class AnnotationHelper {
     ...
     * @param clazz The class, not null
     * @param annotation The annotation, not null
     * @param includeInherited True for also looking for methods in
     *            super-classes
     * @return A List containing methods annotated with the given annotation,
     *         empty list if none found
     */
     ...
     * @param <S>
     * @param <T>
     * @param annotationClass 要获取属性的Annotation class
     * @param annotationPropertyName 要获取的属性值的属性名称
     * @param defaultValue 属性的默认值
     * @param method 要获取Annotation属性的方法
     * @param clazz 要获取Annotation属性的类
     * @return
     */
     ...
     * @param annotationClass 要获取属性的Annotation class
     * @param annotationPropertyName 要获取的属性值的属性名称
     * @param defaultValue 要获取Annotation属性的方法
     * @param clazz 要获取Annotation属性的类
     * @return
     */
