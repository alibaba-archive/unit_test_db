package com.aliyun.jtester.tools.reflector;
...
import com.aliyun.jtester.tools.commons.MethodHelper;
...
public class MethodAccessor<T> {
    ...
    public T invokeStatic(Object[] args) throws Exception {
        if (Modifier.isStatic(method.getModifiers()) == false) {
            ...
            throw new NoSuchMethodRuntimeException(
                    "No such static method: " + methodDesc + " in class[" + this.targetClaz + "]");
        } else {
     ...
     * @throws JTesterException if the method could not be invoked
     */
