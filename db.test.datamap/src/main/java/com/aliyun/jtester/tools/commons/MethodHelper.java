package com.aliyun.jtester.tools.commons;
...
import com.aliyun.jtester.tools.exception.NoSuchMethodRuntimeException;
import com.aliyun.jtester.tools.reflector.MethodAccessor;
import com.aliyun.jtester.tools.reflector.ReflectionException;
...
public final class MethodHelper {
     ...
     * <ul>
     * <li>Method name is {@literal >} 3 characters long and starts with set</li>
     * <li>The fourth character is in uppercase</li>
     * <li>The method has one parameter, with the type of the property to set
     * </li>
     * </ul>
     * 
     * @param method The method to check, not null
    ...
    public static boolean isSetterMethod(Method method) {
        ...
        if (methodName.startsWith("set") == false || method.getParameterTypes().length != 1
                || methodName.length() < 4) {
            return false;
        }
