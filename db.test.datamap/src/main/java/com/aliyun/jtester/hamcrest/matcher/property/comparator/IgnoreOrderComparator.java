...
import com.aliyun.jtester.hamcrest.matcher.property.reflection.MatchingScoreCalculator;
...
public class IgnoreOrderComparator implements Comparator {
    ...
    public Difference compare(Object left, Object right, boolean onlyFirstDifference,
        ...
        UnorderedCollectionDifference difference = new UnorderedCollectionDifference("Collections/arrays are different",
                left, right, leftList, rightList);
     ...
     * @param reflectionComparator reflectionComparator The comparator for the
     *            element comparisons, not null
     ...
     * @param leftList The left list, not null
     * @param rightList The right list, not null
     * @param reflectionComparator The comparator for element comparisons, not
     *            null
     * @param difference The root difference to which all differences will be
     *            added, not null
     */
     ...
     * @param leftList The left list, not null
     * @param rightList The right list, not null
     * @param difference The difference to which all indexes will be added, not
     *            null
     */
     ...
     * 
     * @param leftIndexes The current remaining indexes in the left collection,
     *            not null
     * @param rightIndexes The current remaining indexes in the right
     *            collection, not null
     * @param difference The difference to which all indexes will be added, not
     *            null
     */
