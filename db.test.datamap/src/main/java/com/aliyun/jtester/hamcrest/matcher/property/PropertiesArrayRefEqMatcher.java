...
public class PropertiesArrayRefEqMatcher extends BaseMatcher<Object> {
    ...
    public void describeTo(Description description) {
        ...
        description.appendText(String.format(",but actual value is:%s, not matched value[%s]",
                StringHelper.toString(this.propertyValues), StringHelper.toString(this.expected)));
    }
}
