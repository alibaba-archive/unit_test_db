package com.aliyun.jtester.hamcrest.matcher.clazz;
...
public class ClassAssignFromMatcher extends BaseMatcher {
    ...
    public void describeTo(Description description) {
        description.appendText(String.format("the class[%s] isn't assignable from class[%s]",
                actual == null ? "<null>" : actual.getName(), wanted == null ? "<null>" : wanted.getName()));
    }
}
