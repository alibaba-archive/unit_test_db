package com.aliyun.jtester.hamcrest.matcher.property.reflection;

import static com.aliyun.jtester.hamcrest.matcher.property.reflection.EqMode.IGNORE_DATES;
import static com.aliyun.jtester.hamcrest.matcher.property.reflection.EqMode.EQ_STRING;
import static com.aliyun.jtester.hamcrest.matcher.property.reflection.EqMode.IGNORE_DEFAULTS;
import static com.aliyun.jtester.hamcrest.matcher.property.reflection.EqMode.IGNORE_ORDER;

import java.util.ArrayList;
import java.util.List;

import com.aliyun.jtester.hamcrest.matcher.property.comparator.ListComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.Comparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.EqStringComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.HibernateProxyComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.IgnoreDefaultsComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.IgnoreDatesComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.IgnoreNumberComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.IgnoreOrderComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.MapComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.ObjectComparator;
import com.aliyun.jtester.hamcrest.matcher.property.comparator.SimpleCasesComparator;
...
public class ReflectionComparatorFactory {
	...
	protected static List<Comparator> getComparatorChain(List<EqMode> modes) {
		...
		if (modes.contains(EqMode.IGNORE_DATES)) {
			comparatorChain.add(LENIENT_DATES_COMPARATOR);
		}
		if (modes.contains(EqMode.EQ_STRING)) {
			comparatorChain.add(EQ_STRING_COMPARATOR);
		}
		if (modes.contains(EqMode.IGNORE_DEFAULTS)) {
		...
		if (modes.contains(EqMode.IGNORE_ORDER)) {
