...
public class FileAssert extends BaseAssert<File, IFileAssert> implements IFileAssert {
    ...
    public IFileAssert isExists() {
        FileExistsMatcher matcher = new FileExistsMatcher((File) this.value,
                FileExistsMatcher.FileExistsMatcherType.ISEXISTS);
        return this.assertThat(matcher);
    }

    public IFileAssert unExists() {
        FileExistsMatcher matcher = new FileExistsMatcher((File) this.value,
                FileExistsMatcher.FileExistsMatcherType.UNEXISTS);
        return this.assertThat(matcher);
    }
