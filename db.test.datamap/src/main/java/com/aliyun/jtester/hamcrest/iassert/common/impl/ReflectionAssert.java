...
import com.aliyun.jtester.hamcrest.matcher.property.MapPropertyEqaulMatcher;
import com.aliyun.jtester.hamcrest.matcher.property.PropertiesEqualMatcher;
import com.aliyun.jtester.hamcrest.matcher.property.PropertyEqualMatcher;
import com.aliyun.jtester.hamcrest.matcher.property.PropertyEqualStringMatcher;
import com.aliyun.jtester.hamcrest.matcher.property.PropertyItemMatcher;
...
public class ReflectionAssert<T, E extends IAssert> extends ListHasItemsAssert<T, E> implements IReflectionAssert<E> {
    ...
    public E eqIgnoreAll(Object expected) {
        ...
        ReflectionEqualMatcher matcher = new ReflectionEqualMatcher(expected,
                new EqMode[] { EqMode.IGNORE_ORDER, EqMode.IGNORE_DEFAULTS, EqMode.IGNORE_DATES });
        return this.assertThat(matcher);
    }
