package com.aliyun.jtester.hamcrest.matcher.property.difference;
...
public class CollectionDifference extends Difference {
     ...
     */
    public CollectionDifference(String message, Object leftValue, Object rightValue, List<?> leftList,
                                List<?> rightList) {
    ...
    /**
     * Double dispatch method. Dispatches back to the given visitor.<br>
     * All subclasses should copy this method in their own class body.
     * 
     * @param visitor The visitor, not null
     * @param argument An optional argument for the visitor, null if not
     *            applicable
     * @return The result
     */
    @Override
