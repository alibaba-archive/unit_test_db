...
import com.aliyun.jtester.json.encoder.array.ArraysEncoder;
import com.aliyun.jtester.json.encoder.array.CollectionEncoder;
import com.aliyun.jtester.json.encoder.object.MapEncoder;
import com.aliyun.jtester.json.encoder.object.PoJoEncoder;
import com.aliyun.jtester.json.encoder.object.SpecEncoder;
...
import com.aliyun.jtester.json.helper.ClazzMap;
import com.aliyun.jtester.json.helper.JSONFeature;
...
public abstract class JSONEncoder<T> {
     ...
     * @param value 要序列化的对象
     * @param writer
     * @param references 已序列化的对象地址标识列表
     * @param isMarkRef 是否增加对象地址标识, 下列情形下不标识：<br>
     *            o 简单对象<br>
     *            o 有时不标识是为了防止多个地方调用结果自己引用了自己, 如果EntryEncoder中会判断一遍，再转到普通对象中编码
     *            <br>
