package com.aliyun.jtester.json.decoder;
...
import com.aliyun.jtester.json.decoder.base.DecoderException;
import com.aliyun.jtester.json.decoder.base.MapPoJoBaseDecoder;
...
import com.aliyun.jtester.tools.commons.FieldHelper;
    ...
    protected Object getTarget(JSONMap map, Type toType) {
        ...
        if (this.isInterfaceOrAbstract(claz)) {
            throw new DecoderException(
                    "the type[" + claz.getName() + "] is an interface or abstract class,that can't be instnaced.");
